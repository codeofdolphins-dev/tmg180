export default function LockIllustration() {
  return (
    <div className="relative w-24 h-24 mb-6">
      ...
      <div className="w-24 h-24 rounded-full bg-purple-100/70 flex items-center justify-center shadow-inner">
        <svg
          width="64"
          height="64"
          viewBox="0 0 64 64"
        ...
        >
          <defs>
            <linearGradient id="lockBg" x1="0" y1="0" x2="64" y2="64" gradientUnits="userSpaceOnUse">
              ...
              <stop offset="1" stopColor="#c9a8e0" />
            </linearGradient>
          ...
          <circle cx="32" cy="38" r="3.2" fill="#3b0764" />
          <rect x="30.2" y="40" width="3.6" height="6" rx="1.5" fill="#3b0764" />
        </svg>
      </div>
    </div>
  );
